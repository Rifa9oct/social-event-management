            ...
            <div className="bg-neutral-100 rounded-lg">
                ...
                <div className="flex items-center gap-3 mx-auto justify-center md:justify-start">
                    <div className="flex flex-col md:flex-row gap-3 items-center">
                        ...
                        <p className="mt-10 p-8 border-[18px] rounded-lg border-blue-200 w-[350px] lg:w-[300px] lg:[300px] text-justify">
                    ...
                    <div>
                        ...
                        <img className="absolute left-[125px] md:left-[450px] lg:left-[470px] top-[880px] md:top-[1065px] lg:top-[1050px] w-[150px] md:w-[200px] h-[150px] md:h-[200px] lg:w-[300px] lg:h-[300px] rounded-full" src={clint_1} />
                    </div>
                </div>
                ...
                <div className="flex items-center gap-3 mt-[150px] md:mt-[50px] lg:mt-[-100px] mb-40 mx-auto justify-center md:justify-end">
                    <div>
                        ...
                        <img className="absolute left-[145px] md:left-[120px] lg:left-[700px] top-[1410px] md:top-[1565px] lg:top-[1460px] w-[150px] md:w-[200px] h-[150px] md:h-[200px] lg:w-[300px] lg:h-[300px] rounded-full" src={clint_2} />
                    </div>
